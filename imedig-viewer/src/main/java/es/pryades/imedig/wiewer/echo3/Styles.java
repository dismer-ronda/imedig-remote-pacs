...
public class Styles
{
	public static final String STYLE_PATH = "/es/pryades/imedig/wiewer/resource/style/";
	public static final String IMAGE_PATH = "/es/pryades/imedig/wiewer/resource/image/";
