...
public class ReportsListTab extends FilteredContent implements ModalParent, Property.ValueChangeListener
{
	...
	private BeanItem<ReportsListTab> bi;
	 ...
	 * @param resource
	 */
	public ReportsListTab( ImedigContext ctx )
	{
		super( ctx );
	...
	public void onModifyRow( Object row )
	{
		...
		new ModalNewInforme( getContext(), Operation.OP_MODIFY, informe, images, ReportsListTab.this, right ).showModalWindow();
	}
	...
	public void onDeleteRow( Object row )
	{
		...
		new ModalNewInforme( getContext(), Operation.OP_DELETE, informe, images, ReportsListTab.this, "informes.crear" ).showModalWindow();
	}
	...
	public Component getQueryComponent()
	{
		...
		bi = new BeanItem<ReportsListTab>( this );
