...
import es.pryades.imedig.cloud.core.dal.CitasManagerImpl;
...
import es.pryades.imedig.cloud.core.dal.RecursosManagerImpl;
...
import es.pryades.imedig.cloud.core.dal.TipoHorarioManagerImpl;
...
public class StandaloneModule implements Serializable 
{
	...
	public static void bind( ServiceBinder binder )
	{
		...
		binder.bind( RecursosManager.class, RecursosManagerImpl.class );
		binder.bind( CitasManager.class, CitasManagerImpl.class );
		...
		binder.bind( TipoHorarioManager.class, TipoHorarioManagerImpl.class );
