...
import es.pryades.imedig.cloud.core.dal.EquiposManager;
import es.pryades.imedig.cloud.core.dal.EquiposManagerImpl;
...
public class StandaloneModule implements Serializable 
{
	...
	public static void bind( ServiceBinder binder )
	{
		...
		binder.bind( EquiposManager.class, EquiposManagerImpl.class );
